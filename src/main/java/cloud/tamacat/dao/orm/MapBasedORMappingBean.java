...
public class MapBasedORMappingBean<T extends MapBasedORMappingBean<T>>
	...
	public String getSize(String value) {
		...
		if (length < 1024) {
			...
			return BigDecimal.valueOf((double)length/1024).setScale(1, RoundingMode.HALF_UP) +" KB";
		} else if (length <1024*1024*1024) {
			return BigDecimal.valueOf((double)length/1024/1024).setScale(1, RoundingMode.HALF_UP) +" MB";
		} else {
			return BigDecimal.valueOf((double)length/1024/1024/1024).setScale(1, RoundingMode.HALF_UP) +" GB";
		}
	}
